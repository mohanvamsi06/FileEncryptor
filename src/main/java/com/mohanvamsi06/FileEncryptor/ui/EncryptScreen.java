        ...
        e -> {
          ...
          if (filePath.equals("No file selected")) {
            JOptionPane.showMessageDialog(
                this, "Please select a file to encrypt!", "Error", JOptionPane.ERROR_MESSAGE);
            return;
          }

          if (password.isEmpty()) {
            JOptionPane.showMessageDialog(
                this, "Please enter a password!", "Error", JOptionPane.ERROR_MESSAGE);
            return;
          }

          if (!password.equals(confirmPassword)) {
            JOptionPane.showMessageDialog(
                this, "Passwords do not match!", "Error", JOptionPane.ERROR_MESSAGE);
            return;
          }

          String algorithm =
              desButton.isSelected() ? "des" : aesButton.isSelected() ? "aes" : "blowfish";
          ...
          if (result == 0) {
            JOptionPane.showMessageDialog(
                this, "Encryption successful!", "Success", JOptionPane.INFORMATION_MESSAGE);
            clearFields();
            keepOriginalCheckBox.setSelected(true);
          } else {
            JOptionPane.showMessageDialog(
                this,
                "Encryption failed! Error code: " + result,
                "Error",
