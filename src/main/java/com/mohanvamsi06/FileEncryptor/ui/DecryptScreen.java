        ...
        e -> {
          ...
          if (filePath.equals("No file selected")) {
            JOptionPane.showMessageDialog(
                this, "Please select a file to decrypt!", "Error", JOptionPane.ERROR_MESSAGE);
            return;
          }
          ...
          if (result == 0) {
            JOptionPane.showMessageDialog(
                this, "Decryption successful!", "Success", JOptionPane.INFORMATION_MESSAGE);
            clearFields();
          } else {
            String errorMessage = Encryptor.getErrorMessage(result);
            JOptionPane.showMessageDialog(
                this, "Decryption failed! " + errorMessage, "Error", JOptionPane.ERROR_MESSAGE);
          }
        });
